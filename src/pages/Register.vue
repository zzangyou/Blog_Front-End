                ...
                >
                  ...
                  >
                    <div class="flex border">
                      ...
                      <el-input v-model="ruleForm.username" class="inputDeep" size="large"> </el-input>
                    </div>
                  </el-form-item>
                  ...
                  <el-form-item label="确认密码" prop="checkPass">
                    <div class="flex border">
                      ...
                      <el-input v-model="ruleForm.checkPass" type="password" autocomplete="off" class="inputDeep" />
                    </div>
                  </el-form-item>
                  <el-form-item
                    prop="email"
                  ...
                  <el-form-item label="验证码" prop="checkVerificationCode">
                    <div class="flex border">
                      ...
                      <el-input
                        ...
                        type="text"
                        autocomplete="off"
                        class="inputDeep VertificationCode"
                      />
